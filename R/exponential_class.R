...
#' Factory of Exponential survival distributions object
#'
#' Create an object of the Exponential distribution family.
#'
#' @param ... Pameters to define the distribution. See the notes for deatils
#' @return a SURVIVAL object of the exponential distribution family
#' @export
  ...
  .factory_exponential <- function(
    ...
    structure(
      list(
        ...
        rsurvhr = function(hr){
          stopifnot("Must be positive numbers" = all(hr > 0))

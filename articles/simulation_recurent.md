...
This document presents a way to simulate a trial with multiple events
...
homogeneous Poisson process as described by Leemis (1987).

## Trial simulation

A total of 1000 trials are simulated using a survival object of class
...
# Distribution of the simulated hazard ratios

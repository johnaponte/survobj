...
In this example, simulation of the surival times in the control group
...
-   The simulated data is analized using Cox regression, and evaluate
    the proportionality of the hazard assumption following the method
...
proprotionality of the hazard assumption in this condition as

...
The empirical power is defined as the percentage of times the p-value for the
coefficient that indicates the treatment is equal to or below 0.05.
...
As reference, the output of the power calculation using PASS 2021(R) with
the same parameters

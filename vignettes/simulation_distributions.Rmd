...
If the proportional hazard and the accelerated failure is combined and accelerated hazard time is generated. This can be acomplished with the function `rsurvah()` function and the `ggplot_random_ah()` functions
